...
public class WeChatPayUtil {
    ...
    /**
     * Get the client tool object that calls the WeChat interface
     *
     * @return
     */
    private CloseableHttpClient getClient() {
        ...
        try {
            //merchantPrivateKey merchant API private key, how to load merchant API private key please see FAQ
            merchantPrivateKey = PemUtil.loadPrivateKey(new FileInputStream(new File(weChatProperties.getPrivateKeyFilePath())));
            //Load platform certificate file
            X509Certificate x509Certificate = PemUtil.loadCertificate(new FileInputStream(new File(weChatProperties.getWeChatPayCertFilePath())));
            //wechatPayCertificatesWeChat payment platform certificate list.
            // You can also use the "regularly updated platform certificate function"
            // without having to worry about the ins and outs of the platform certificate.
            ...
            // The HttpClient constructed through WechatPayHttpClientBuilder will automatically handle signature and verification.
    ...
    public JSONObject pay(String orderNum, BigDecimal total, String description, String openid) throws Exception {
        ...
        if (prepayId != null) {
            ...
            //Sign for the second time, you need to sign again when transferring payment.
