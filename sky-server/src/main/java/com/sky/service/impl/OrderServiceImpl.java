...
public class OrderServiceImpl implements OrderService {
    ...
    public void paySuccess(String outTradeNo) {
        ...
        //Push messages to client browser via websocket： type, orderId, content
        Map map = new HashMap();
        map.put("type", 1);//1. Order reminder, 2. Customer reminder
    ...
    public void complete(Long id) {
        ...
        //Check if the order exists or not, and if the status is 4
        ...
        //Update the order status, converting it to be complete
